...
def franchise_profile_feature_row(team1_name: str, team2_name: str) -> dict[str, float]:
    ...
    return {
        ...
        "team1_death_bat_ratio": p1["death_bat_ratio"],
        "team2_death_bat_ratio": p2["death_bat_ratio"],
        "team1_death_bowl_stingy": p1["death_bowl_stingy"],
        "team2_death_bowl_stingy": p2["death_bowl_stingy"],
